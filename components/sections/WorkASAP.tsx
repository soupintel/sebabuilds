...
export default function WorkASAP() {
  ...
  return (
    ...
    >
      ...
      {/* Horizontal rule cutting across for tension */}
      <div className="pointer-events-none absolute left-0 top-[45%] z-0 hidden h-px w-full bg-fg opacity-[0.12] md:block" />
      ...
      <motion.div
        ...
        className="pointer-events-none absolute left-[-14%] top-1/2 hidden -translate-y-1/2 md:block"
      >
        <svg
          viewBox="0 0 200 200"
          xmlns="http://www.w3.org/2000/svg"
